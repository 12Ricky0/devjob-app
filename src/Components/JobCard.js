        ...
        <div>
            ...
            <MediaQuery minWidth={700}>
                <form className="flex justify-center bg-secondary-white dark:bg-primary-very-dark-blue w-[87%] lg:w-[78%] md:w-[88%] m-auto rounded-md px-6 h-20 relative top-[-40px]">
                    <div className="flex w-[40%] md:w-[35%] py-8">
                    ...
                    <div className="border-x border-x-secondary-dark-gray flex w-[25%] md:w-[35%] items-center border-opacity-20">
                    ...
                    <div className="flex items-center">
                        <label className="group cursor-pointer mx-4">
                            ...
                            <span className="checkmark w-6 h-6 relative rounded-[3px] inline-block bg-secondary-dark-gray opacity-10"></span>
                        </label>
            ...
            <section className="lg:grid lg:grid-cols-3 lg:mx-[10%] md:grid md:grid-cols-2 lg:mt-[60px] md:mx-[4%] mt-[30px]">
